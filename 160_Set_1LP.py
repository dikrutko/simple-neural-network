...
for obj in filenameTest:
   ...
   folder = os.makedirs("./160/Set_1LP/Test/{}".format(obj), exist_ok=True)
   str_new_dir = "./160/Set_1LP/Test/"+obj
...
for obj in filenameTest:
   ...
   folder = os.makedirs("./160/Set_1LP/Training/{}".format(obj), exist_ok=True)
   str_new_dir = "./160/Set_1LP/Training/"+obj
   for image in past_dir:
      im = Image.open(str_past_dir+'/'+image)
      w,h = im.size
      new_im=im.resize((160,160))
...
for obj in filenameTest:
   ...
   folder = os.makedirs("./160/Set_1LP/Valid/{}".format(obj), exist_ok=True)
   str_new_dir = "./160/Set_1LP/Valid/"+obj
   for image in past_dir:
      im = Image.open(str_past_dir+'/'+image)
      w,h = im.size
      new_im=im.resize((160,160))
